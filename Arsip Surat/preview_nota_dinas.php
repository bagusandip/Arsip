<?php
if (empty($_GET['no_surat_nota_dinas'])) {
		...
		<nav class="navbar navbar-inverse" style="border-radius: 0px; box-shadow: 0 5px 5px rgba(0, 0, 0, 0.3);">
			<div class="container-fluid">
				...
				<ul class="nav navbar-nav">
					...
					<li><a href="surat_undangan.php" style="font-size: 17px;">Surat Undangan</a></li>
				</ul>
		...
		<center>
			...
			<table border="1px" class="backg top">
				<tr style="border : none;" class="top">
					<td width="20%" class="right bottom top" >Nomor Surat</td>
					<td width="2%" class="left right bottom top">:</td>
					<td width="78%" class="left bottom top"><?php echo $data['no_agenda']."/".$data['no_surat_nota_dinas']."/".$nms."/".$ys ?></td>
				</tr>
				...
				<tr style="border: none;">
					<td class="right bottom top" >Tujuan</td>
					<td class="left right bottom top">:</td>
					<td class="left bottom top justify"><?php echo $data['tujuan'];?></td>
				</tr>
			</table>
		</center>
	</head>
