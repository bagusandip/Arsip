...
<head>
  ...
  <script>
    $(document).ready(function(){
      $("#tgl").change(function(){
        $("#tgl_berangkat").attr("min", $("#tgl").val());
      });
    });
  </script>
	<div class="container">
	<h2>Tambah Data Surat Keluar<hr></h2>
  <ul class="breadcrumb">
        <li><a href="beranda_admin.php">Beranda</a></li>
        <li><a href="surat_keluar.php">Arsip Surat Keluar</a></li>
        <li>Tambah Data Surat Keluar</li>
  </ul>
</div>
<style type="text/css">
    #tabeltambah tr td{
...
<body>
<div class="container">
	<form  action="proses_tambah_surat_keluar.php" method="post">
  ...
  <tr>
	...
	<tr>
		...
		<td><input type="text" name="no_surat_keluar" class="form-control" id="nomor" style="width: 500px" required=""></td>
	</tr>
  <tr>
    ...
    <tr>
      ...
      <td><input type="date" name="tgl_berangkat" class="form-control" id="tgl_berangkat" style="width: 200px" required=""></td>
    </tr>
	<tr>
